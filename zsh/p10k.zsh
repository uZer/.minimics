# Generated by Powerlevel10k configuration wizard on 2023-03-04 at 01:22 CET.
...
() {
  ...
  # Branch icon. Set this parameter to '\UE0A0 ' for the popular Powerline branch icon.j
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=9
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|x|ns'
